...
int main() { 
	...
	SC1: 
	printf("\nWELCOME TO SCIENTIFIC CALCULATION\n\n");
	...
	do {
		...
		case 1:
			...
			case 4: printf("Enter the 1st number:");          
				...
				scanf("%d", &flag);
				break;
			case 5: printf("you have chosen to do x^n\n");
		...
		do {
			...
			printf("Which of the following operations would you like to do?\n");
				...
				case 1:	printf("Enter the number to be added with the result:");
					scanf("%lf", &x);
					res = addition(res, x);   
					printf("\n result = %lf", res);
					printf("\n do you want to continue with the operation. If yes then set flag=1 else set flag=0 \n");
					...
					scanf("%d", &flag);
					break;
				case 2:	printf("Enter the number to be subtracted with the result:"); 
					scanf("%lf", &x);
					...
					scanf("%d", &flag);
					break;
				case 3: printf("Enter the number to be multiplied with the result:"); 
					scanf("%lf", &x);
					...
					scanf("%d", &flag);
					break;
				case 4: printf("Enter the number to be divided with the result:"); 
					scanf("%lf", &x);
					res = division(res, x);
					printf("\n result = %lf", res);
					printf("\n do you want to continue with the operation. If yes then set flag=1 else set flag=0 \n");
        ...
        switch(choice[0]) {
			...
			printf("continue? Y/N\n");
				...
				system("clear");
                        ...
                        break;
       		case'2':printf("enter x and y co-ordinates of two points in the format\n");
			...
			printf("continue? Y/N\n");
                        ...
                        break;
          	case'3':printf("enter x and y co-ordinates of two points in the format \n");
                        printf("for first point  (x,y) = \n");
                        scanf("%lf%lf", &x1, &y1);
                        printf("for second point (x,y) = \n");
                        scanf("%lf%lf", &x2, &y2);
